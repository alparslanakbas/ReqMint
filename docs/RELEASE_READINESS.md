...
Platform packaging workflows additionally verify package structure, target architecture, metadata, signatures where applicable, and SHA-256 checksums. Apple notarization and Microsoft Store certification remain external gates and cannot be replaced by a unit test.
